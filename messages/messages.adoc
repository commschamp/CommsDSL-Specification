...
In some cases the message object construction may require updating some
...
as the <<fields-optional, &lt;optional&gt; >> field's <<fields-optional-existence-conditions, existence conditions>>.
[source,xml]
----
<?xml version="1.0" encoding="UTF-8"?>
<schema ...>
