...
It is possible to copy construction requirements from one message definition to another to avoid unnecessary duplication
using **copyConstructFrom** property.
[source,xml]
----
<?xml version="1.0" encoding="UTF-8"?>
<schema ...>
...
It is possible to copy read conditions from one message definition to another to avoid unnecessary duplication
using **copyReadCondFrom** property.
[source,xml]
----
<?xml version="1.0" encoding="UTF-8"?>
<schema ...>
...
It is possible to copy validity conditions from one message definition to another to avoid unnecessary duplication
using **copyValidCondFrom** property.
[source,xml]
----
<?xml version="1.0" encoding="UTF-8"?>
<schema ...>
...
[[messages-reusing-other-messages]]
...
**Note** that some message definition properties mentioned earlier (such as
**copyFieldsFrom**, **copyConstructFrom**, **copyReadCondFrom**, etc...) are __action__ ones. They
force copy of elements from one message to another and disappear when it comes to
<<messages-reusing-other-messages, reuse>> of the message definition that uses them.
