...
[[messages-copying-overriding-code]]
=== Copying Overriding Code ===
In some cases different messages may have the **same** overriding code that needs to be injected. In 
...
<schema ...>
    ...
    <message name="Msg2" copyOverrideCodeFrom="Msg1">
            ...
    </message>
</schema>
----
...
<schema ...>
    ...
    <message name="Msg2" copyOverrideCodeFrom="Msg1" nameOverride="none">
            ...
    </message>
</schema>
----
