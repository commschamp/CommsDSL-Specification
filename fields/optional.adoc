...
When the *read* operation is complete, the mode of the field is expected to be
changed automatically to either **exist** or **missing** depending on whether
the relevant data was read or not.
