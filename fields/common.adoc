...
[[fields-common-copying-overriding-code]]
==== Copying Overriding Code ====
In some cases different fields may have the **same** overriding code that needs to be injected. In 
order to minimize the copy-paste of the code, the CommsDSL introduces the 
**copyOverrideCodeFrom** property with a <<intro-references, reference>> value indicating
...
<schema ...>
    <fields>
        ...
        <bundle name="AnotherCompositeField" copyOverrideCodeFrom="CompositeField">
            ...
        </bundle>
    </fields>
</schema>
----
Note, that **copyOverrideCodeFrom** property is applied before any **xOverride**
...
<schema ...>
    <fields>
        ...
        <bundle name="AnotherCompositeField" copyOverrideCodeFrom="CompositeField" nameOverride="none">
            ...
        </bundle>
    </fields>
</schema>
